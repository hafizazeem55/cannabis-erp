...
class EnvironmentalThresholdSeeder extends Seeder
{
    public function run(): void
    {
        $records = [
            // Clone
            ['stage' => 'clone', 'parameter' => 'temperature', 'min' => 20, 'max' => 24, 'target' => 22, 'tol' => 3, 'severity' => 'warning'],
            ['stage' => 'clone', 'parameter' => 'humidity', 'min' => 70, 'max' => 85, 'target' => 80, 'tol' => 3, 'severity' => 'warning'],
            ['stage' => 'clone', 'parameter' => 'co2', 'min' => 800, 'max' => 1200, 'target' => 1000, 'tol' => 10, 'severity' => 'standard'],
            ['stage' => 'clone', 'parameter' => 'ph', 'min' => 5.6, 'max' => 6.1, 'target' => 5.9, 'tol' => 3, 'severity' => 'standard'],
            ['stage' => 'clone', 'parameter' => 'ec', 'min' => 0.40, 'max' => 0.80, 'target' => 0.60, 'tol' => 5, 'severity' => 'standard'],

            // Propagation
            ['stage' => 'propagation', 'parameter' => 'temperature', 'min' => 22, 'max' => 27, 'target' => 24, 'tol' => 4, 'severity' => 'warning'],
            ['stage' => 'propagation', 'parameter' => 'humidity', 'min' => 60, 'max' => 75, 'target' => 68, 'tol' => 4, 'severity' => 'warning'],
            ['stage' => 'propagation', 'parameter' => 'co2', 'min' => 900, 'max' => 1400, 'target' => 1100, 'tol' => 10, 'severity' => 'standard'],
            ['stage' => 'propagation', 'parameter' => 'ph', 'min' => 5.8, 'max' => 6.2, 'target' => 6.0, 'tol' => 3, 'severity' => 'standard'],
            ['stage' => 'propagation', 'parameter' => 'ec', 'min' => 0.80, 'max' => 1.20, 'target' => 1.00, 'tol' => 5, 'severity' => 'standard'],
            ...
            // Flower
            ['stage' => 'flower', 'parameter' => 'temperature', 'min' => 18, 'max' => 26, 'target' => 22, 'tol' => 5, 'severity' => 'critical'],
            ['stage' => 'flower', 'parameter' => 'humidity', 'min' => 40, 'max' => 60, 'target' => 50, 'tol' => 5, 'severity' => 'critical'],
            ['stage' => 'flower', 'parameter' => 'co2', 'min' => 1100, 'max' => 1700, 'target' => 1400, 'tol' => 10, 'severity' => 'standard'],
            ['stage' => 'flower', 'parameter' => 'ph', 'min' => 5.7, 'max' => 6.3, 'target' => 6.0, 'tol' => 3, 'severity' => 'standard'],
            ['stage' => 'flower', 'parameter' => 'ec', 'min' => 1.60, 'max' => 2.40, 'target' => 2.00, 'tol' => 7, 'severity' => 'warning'],
